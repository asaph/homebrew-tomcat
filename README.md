...
Note: The tomcat formula included in this tap will generate self-signed SSL certs. These certs are
suitable for development use only. Production sites should swap out the self-signed SSL certs generated by this
tap for real ones purchased from a trusted vendor.
